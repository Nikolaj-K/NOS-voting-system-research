...
As Kenneth Arrow discovered, for an election with three or more candidates, it is impossible for a voting system to satisfy all five of the conditions above.  \\
