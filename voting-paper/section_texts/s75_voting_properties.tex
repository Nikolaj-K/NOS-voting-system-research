...
is the only voting system for two-candidate-elections that is anonymous, neutral, and monotone, and that avoids the possibility of ties. For more than two candidates this is not true, since it is not guarantueed that one of the candidates is voted for by more than half of all voters. Since in the dApp-voting-system there will be more than two candidates, majority rule wouldn't fulfill %TODO and anonymity is likely an undesired feature. \\ 
For more than two 
