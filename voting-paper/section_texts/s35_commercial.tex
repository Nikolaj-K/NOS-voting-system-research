...
{\color{green}{
	...
	Add GURU paper link
	{It seems natural to do this by reputation. Reputation systems are abundant in our society from online auctions and marketplaces like eBay, Amazon, credit ratings like Standard \& Pooras, Fitch, Moodyas to social networks and even academic citations.}
...
\subsection{Polling and voting software}

(this names just a few)

\subsubsection{Chat plugins}

(describe what it is)

\subsubsection{Polling platforms}

(https://en.wikipedia.org/wiki/ Quadratic voting)

(look the project relating to this up again)
